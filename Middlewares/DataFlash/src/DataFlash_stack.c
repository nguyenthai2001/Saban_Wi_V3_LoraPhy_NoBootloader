...
//      printf("\n[Simulate EEPROM base address at Data Flash 0x%x]\n\n", BaseAddr);
      ...
      MasterDataFlash[1].Modbus_Baudrate = SIM_EEPROM_READ(8);
			...
			{
				case 0x00 : device[1].Modbus_mode = 0 ;                // Slave
					   break ;
				case 0x01 : device[1].Modbus_mode = 0 ;
					   break ;
				case 0x02 : device[1].Modbus_mode = 0 ;
					   break ;
				case 0x03 : device[1].Modbus_mode = 0 ;
					   break ;
				case 0x10 : device[1].Modbus_mode = 1 ;                  // master
					   break ;
				case 0x11 : device[1].Modbus_mode = 1 ;
					   break ;
				case 0x12 : device[1].Modbus_mode = 1 ;
					   break ;
				case 0x13 : device[1].Modbus_mode = 1 ;
					   break ;
			}
