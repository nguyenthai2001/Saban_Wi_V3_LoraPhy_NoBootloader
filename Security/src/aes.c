...
void test1_decrypt_cbc(void)
{
//    int timestart = 0 ;
//    int timestop  = 0;
//	 // KhÃ³a AES-128 (16 byte)
...
//    memcpy(ciphertext, padded_data, 16);
//    timestop = Timer3_GetTickMs();
//    Timer3_ResetTickMs();
//    // In du lieu truoc ma hoa 
//    print_hex("Ciphertext: ", ciphertext, 16);   
//    printf("CBC encrypt TIME:%d ms\n\r",timestop-timestart);

//    // Giai ma 
//    Timer3_SetTickMs();
//    timestart = Timer3_GetTickMs();
//    AES_init_ctx_iv(&ctx, key, iv);  
//    AES_CBC_decrypt_buffer(&ctx, ciphertext, 16);
//    timestop = Timer3_GetTickMs();
//    Timer3_ResetTickMs();
//    printf("CBC decrypt TIME:%d ms\n\r",timestop-timestart);

//    // In du lieu sau khi giai ma 
//    print_hex("Decrypted text: ", ciphertext, 16);
}
