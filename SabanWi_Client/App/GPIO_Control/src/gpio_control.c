...
/* Check Input Status  */
/*--------------------------------------------------------------------*/
uint8_t Check_Button_Status_1(void)
{      
      ...
      {            
            ...
            if(Time_Falling_1 >= ClientDataFlash[1].timefalsh)
            {
                  u8status_1 = 0b10 ;
            }
            Time_Falling_1 = 0 ;
      ...
      if(PA6 == 0)
      {
            ...
            if(Time_Rising_1 >= ClientDataFlash[1].timefalsh)
            {
                  u8status_1 = 0b01;
            }
            Time_Rising_1 = 0;
...
uint8_t Check_Button_Status_2(void)
{      
      u32int_2 = 1;
      if(PC7 == 1)
      {                       
            if(Time_Falling_2 >= ClientDataFlash[1].timefalsh)
            {
                  u8status_2 = 0b10 ;
            }
            Time_Falling_2 = 0 ;
      ...
      if(PC7 == 0)
      {
            ...
            if(Time_Rising_2 >= ClientDataFlash[1].timefalsh)
            {
                  u8status_2 = 0b01;
            }
            Time_Rising_2 = 0;
...
uint8_t Check_Button_Status_3(void)
{      
      u32int_3 = 1;
      if(PC6 == 1)
      {                       
            if(Time_Falling_3 >= ClientDataFlash[1].timefalsh)
            {
                  u8status_3 = 0b10 ;
            }
            Time_Falling_3 = 0 ;
      ...
      if(PC6 == 0)
      {
            ...
            if(Time_Rising_3 >= ClientDataFlash[1].timefalsh)
            {
                  u8status_3 = 0b01;
            }
            Time_Rising_3 = 0;
...
uint8_t Check_Button_Status_4(void)
{      
      u32int_4 = 1;
      if(PB15 == 1)
      {                       
            if(Time_Falling_4 >= ClientDataFlash[1].timefalsh)
            {
                  u8status_4 = 0b10 ;
            }
            Time_Falling_4 = 0 ;
      ...
      if(PB15 == 0)
      {
            ...
            if(Time_Rising_4 >= ClientDataFlash[1].timefalsh)
            {
                  u8status_4 = 0b01;
            }
            Time_Rising_4 = 0;
...
uint8_t Check_Button_Status_5(void)
{      
      u32int_5 = 1;
      if(PB8 == 1)
      {                       
            if(Time_Falling_5 >= ClientDataFlash[1].timefalsh)
            {
                  u8status_5 = 0b10 ;
            }
            Time_Falling_5 = 0 ;
      ...
      if(PB8 == 0)
      {
            ...
            if(Time_Rising_5 >= ClientDataFlash[1].timefalsh)
            {
                  u8status_5 = 0b01;
            }
            Time_Rising_5 = 0;
...
uint8_t Check_Button_Status_6(void)
{      
      u32int_6 = 1;
      if(PA11 == 1)
      {                       
            if(Time_Falling_6 >= ClientDataFlash[1].timefalsh)
            {
                  u8status_6 = 0b10 ;
            }
            Time_Falling_6 = 0 ;
      ...
      if(PA11 == 0)
      {
            ...
            if(Time_Rising_6 >= ClientDataFlash[1].timefalsh)
            {
                  u8status_6 = 0b01;
            }
            Time_Rising_6 = 0;
...
uint8_t Check_Button_Status_7(void)
{      
      u32int_7 = 1;
      if(PA10 == 1)
      {                       
            if(Time_Falling_7 >= ClientDataFlash[1].timefalsh)
            {
                  u8status_7 = 0b10 ;
            }
            Time_Falling_7 = 0 ;
      ...
      if(PA10 == 0)
      {
            ...
            if(Time_Rising_7 >= ClientDataFlash[1].timefalsh)
            {
                  u8status_7 = 0b01;
            }
            Time_Rising_7 = 0;
...
uint8_t Check_Button_Status_8(void)
{      
      u32int_8 = 1;
      if(PA9 == 1)
      {                       
            if(Time_Falling_8 >= ClientDataFlash[1].timefalsh)
            {
                  u8status_8 = 0b10 ;
            }
            Time_Falling_8 = 0 ;
      ...
      if(PA9 == 0)
      {
            ...
            if(Time_Rising_8 >= ClientDataFlash[1].timefalsh)
            {
                  u8status_8 = 0b01;
            }
            Time_Rising_8 = 0;
 ...
 */	
uint16_t Saban_Input_Control (void)
{
      int i , j ; 
      int pos[8] = {0} ;
      int type[8] = {0} ;
      ...
      for(i = 0; i<8 ;++i)
      {
            if(device[ClientDataFlash[1].SlaveID].data_h & (1<<i))
            {
                  pos[i] = i+1 ;
            }
            else
 ...
 */	
void Saban_Output_Control (void)
{
      int i ; 
      int pos[8] = {0} ;
      for(i = 0; i<8 ;++i)
      {
            if(ClientDataFlash[1].output_number & (1<<i))
            {
                  pos[i] = i+1 ;
            }
            else
