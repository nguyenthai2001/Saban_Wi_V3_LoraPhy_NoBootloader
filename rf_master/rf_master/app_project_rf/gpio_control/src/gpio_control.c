...
void Led_Display(Packet_Rreceive_Data pkg[], uint16_t pos)
{
    if (pkg[pos].cmd == CMD_IO_STANDAND)
    {
        ...
        case 8:
            ...
            break;
        case 9:
            if (combinedValue == DISCONNECT)                     LED9 = 0;
            else if (combinedValue == 0x5555 && combinedValue != DISCONNECT)  LED9 = 1;
            else if (combinedValue != 0x5555 && combinedValue != DISCONNECT)  LED9 = ~LED9;
            break;
        case 10:
            if (combinedValue == DISCONNECT)                     LED10 = 0;
            else if (combinedValue == 0x5555 && combinedValue != DISCONNECT)  LED10 = 1;
            else if (combinedValue != 0x5555 && combinedValue != DISCONNECT)  LED10 = ~LED10;
            break;
        case 11:
            if (combinedValue == DISCONNECT)                     LED11 = 0;
            else if (combinedValue == 0x5555 && combinedValue != DISCONNECT)  LED11 = 1;
            else if (combinedValue != 0x5555 && combinedValue != DISCONNECT)  LED11 = ~LED11;
            break;
        case 12:
            if (combinedValue == DISCONNECT)                     LED12 = 0;
            else if (combinedValue == 0x5555 && combinedValue != DISCONNECT)  LED12 = 1;
            else if (combinedValue != 0x5555 && combinedValue != DISCONNECT)  LED12 = ~LED12;
            break;
        case 13:
            if (combinedValue == DISCONNECT)                     LED13 = 0;
            else if (combinedValue == 0x5555 && combinedValue != DISCONNECT)  LED13 = 1;
            else if (combinedValue != 0x5555 && combinedValue != DISCONNECT)  LED13 = ~LED13;
            break;
        case 14:
            if (combinedValue == DISCONNECT)                     LED14 = 0;
            else if (combinedValue == 0x5555 && combinedValue != DISCONNECT)  LED14 = 1;
            else if (combinedValue != 0x5555 && combinedValue != DISCONNECT)  LED14 = ~LED14;
            break;
        case 15:
            if (combinedValue == DISCONNECT)                     LED15 = 0;
            else if (combinedValue == 0x5555 && combinedValue != DISCONNECT)  LED15 = 1;
            else if (combinedValue != 0x5555 && combinedValue != DISCONNECT)  LED15 = ~LED15;
            break;
        case 16:
            if (combinedValue == DISCONNECT)                     LED16 = 0;
            else if (combinedValue == 0x5555 && combinedValue != DISCONNECT)  LED16 = 1;
            else if (combinedValue != 0x5555 && combinedValue != DISCONNECT)  LED16 = ~LED16;
            break;
