...
double SX1276GetReceiverSensitivity(void) 
{
    double thermalNoisePowerDensity = -174;
	  double noiseFigure = 6;
	  char snr = 0;  
	  double actualBandwidth = 0 ;
	
	  switch(LoRaSettings.SignalBw) // Bandwidth sang Hz (ex: bandwidth = 125 -> 125 kHz = 125000 Hz)
		{
			case 0 : actualBandwidth =  7800; 
				break ;
			case 1 : actualBandwidth =  10400; 
				break ;
			case 2 : actualBandwidth =  15600; 
				break ;
			case 3 : actualBandwidth =  20800; 
				break ;
			case 4 : actualBandwidth =  31200; 
				break ;
			case 5 : actualBandwidth =  41600; 
				break ;
			case 6 : actualBandwidth =  62500; 
				break ;
			case 7 : actualBandwidth =  125000; 
				break ;
			case 8 : actualBandwidth =  250000; 
				break ;
			case 9 : actualBandwidth =  500000; 
				break ;
		}
	  snr = SX1276LoRaGetPacketSnr();
    
    double sensitivity = thermalNoisePowerDensity + 10 * log10(actualBandwidth) + noiseFigure + snr;
