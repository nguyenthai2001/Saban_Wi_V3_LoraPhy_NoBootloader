...
//      printf("[Simulate EEPROM base address at Data Flash 0x%x]\n\n", BaseAddr);
      ...
      ClientDataFlash[1].Modbus_Timeout = SIM_EEPROM_READ(12)<<8 | SIM_EEPROM_READ(13);
			...
			{
						case 0x00 :  device[1].Modbus_mode = 0 ; break ;       // modebus slave
						case 0x01 :  device[1].Modbus_mode = 0 ; break ;   
						case 0x02 :  device[1].Modbus_mode = 0 ; break ;   
						case 0x03 :  device[1].Modbus_mode = 0 ; break ;        

						case 0x10 :  device[1].Modbus_mode = 1 ; break ;        // modbus master
						case 0x11 :  device[1].Modbus_mode = 1 ; break ;   
						case 0x12 :  device[1].Modbus_mode = 1 ; break ;   
						case 0x13 :  device[1].Modbus_mode = 1 ; break ;                     
			} 
}
